            ...
            <div class="row mb-4">
                <div class="col-md-6 text-left">
                    <a href="{{ route('category.show', $category->id) }}" class="btn btn-primary"
                        style="margin-top: 20px;">مشاهده همه</a>
                </div>
                    ...
                    <div class="col-md-4 col-sm-6 mb-4">
                        <div class="blog-post-thumb" style="border: 2px solid #ccc; border-radius: 10px; padding: 15px;">
                            ...
                            <div class="blog-post-image"
                                style="height: 250px; overflow: hidden; border-radius: 10px 10px 0 0;">
                                <a href="{{ route('single', $article->id) }}">
                                    <img src="{{ asset('AdminAssets/Article-image/' . $article->image) }}"
                                        alt="{{ $article->name }}" style="width: 100%; height: 100%; object-fit: cover;">
                                </a>
                            </div>
                            ...
                            <div class="blog-post-format"
                                style="font-size: 14px; color: #666; text-align: center; margin-bottom: 10px;">
                            ...
                            <div class="blog-post-des"
                                style="font-size: 14px; line-height: 1.6; color: #333; text-align: center;">
                                <p>{{ Str::limit($article->description, 120, '...') }}</p>
                            </div>

                            <div style="text-align: center; margin-top: 15px;">
                                <a href="{{ route('single', $article->id) }}" class="btn btn-primary"
                                    style="padding: 10px 20px; font-size: 16px;">ادامه مطلب</a>
                            </div>
                        </div>
                    </div>
                @endforeach
