        ...
        <div class="row mb-4">
            <div class="col-md-12 text-center">
                <h2 class="category-title"
                    style="font-weight: bold; font-size: 2rem; border-bottom: 2px solid #007bff; display: inline-block; padding-bottom: 10px;">
                    {{ $category->name }}
                </h2>
            </div>
        </div>
                ...
                <div class="col-md-4 col-sm-6 mb-4">
                    <div class="card shadow-sm h-100" style="border-radius: 10px; display: flex; flex-direction: column;">
                        ...
                        <a href="{{ route('single', $article->id) }}" class="d-block">
                            <img src="{{ asset('AdminAssets/Article-image/' . $article->image) }}" alt="Blog Image"
                        ...
                        <div class="card-body d-flex flex-column" style="direction: rtl; text-align: right;">
                            ...
                            <div class="text-center mt-auto">
                                <a href="{{ route('single', $article->id) }}" class="btn btn-primary btn-sm px-4">ادامه
                                    مطلب</a>
                            </div>
                        </div>
                    </div>
